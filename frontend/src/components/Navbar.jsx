...
import logo from "../assets/img/logo/Screenshot 2025-10-08 125710.png";
const Navbar = () => {
      ...
      <div className="flex items-center justify-between bg-white shadow-sm px-4 md:px-10 py-3 relative">
        ...
        <div className="flex-shrink-0">
          <Link
            ...
            className="text-xl font-serif tracking-wide text-[#3C5A4C]"
          >
            <img
              src={logo}
              alt="Logo"
        ...
        <div className="hidden lg:flex gap-6 text-[#3C5A4C] font-medium">
          <Link to="/sale" className="hover:text-[#5c7b69]">
            Shop Online Warehouse Sale
          </Link>
        ...
        {mobileMenuOpen && (
          <div className="absolute top-full right-4 mt-2 w-60 bg-white border rounded-lg shadow-md z-50 p-4 lg:hidden text-[#3C5A4C] font-medium space-y-2">
            ...
            <Link to="/furniture" onClick={() => setMobileMenuOpen(false)}>
              Furniture
            </Link>
            <Link to="/homewares" onClick={() => setMobileMenuOpen(false)}>
              Homewares
            </Link>
            <Link to="/shop" onClick={() => setMobileMenuOpen(false)}>
              Shop
            </Link>
            <Link to="/styling" onClick={() => setMobileMenuOpen(false)}>
              Styling
            </Link>
